<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit_User.aspx.cs" Inherits="ASP_2.Edit_User" %>
...
<div></div>
    <form class="user_form" id="form1" runat="server">
       <div>
            <div class="title_form"><span>Edit</span> User Form</div>
           ...
           <div class="role_block">
            ...
            <div class="buttons">                
                <asp:Button CssClass="button_add" ID="Button_Add" runat="server" Text="Save User" OnClick="Button_Save_OnClick" />
